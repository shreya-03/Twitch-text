...
def term_feature_scores(user_hub_scores,session_hub_scores,user_vocab,session_vocab,alpha):
	...
	session_vocab_list = list(session_vocab.keys())
	for index,term in enumerate(user_vocab.keys()):
		...
		feature_scores[index][0] = alpha*user_hub_scores[index][0] + (1-alpha)*session_hub_scores[session_vocab_list.index(term)][0]
...
def ConversationalFeatures(chats_info):
	...
	print("Users list in conversations")
	print(conversations.msgs_per_user.keys())
	...
	msgs_per_user_list = list(conversations.msgs_per_user.keys())
	for id_0,feature_0 in enumerate(user_term_feature_scores.tolist()):
		for id_1,feature_1 in enumerate(user_term_feature_scores.tolist()):
			user_0 = msgs_per_user_list[id_0]
			user_1 = msgs_per_user_list[id_1]
			deg_0 = 0
			deg_1 = 0
			deg_01 = 0
